# Generated by Powerlevel10k configuration wizard on 2025-12-21 at 02:00 CET.
...
# 2 lines, solid, left frame, blue-ornaments, sparse, few icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=15
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=15
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND="#fe8019"
